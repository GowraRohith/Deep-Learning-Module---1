...
class FunctionBase:
    ...
    def apply(cls, *vals):
        ...
        assert isinstance(c, cls.data_type), "Expected return typ %s got %s" % (cls.data_type, type(c),)
    ...
    def chain_rule(cls, ctx, inputs, d_output):
        ...
        # TODO: Implement for Task 1.3. DONE
...
def topological_sort(node):
    ...
    Args:
        node (:class:`Variable`): The right-most variable
